...
AdUi.prototype.createAdContainer = function () {
  ...
  this.adContainerDiv.style.zIndex = 'inherit';
...
AdUi.prototype.onNonLinearAdLoad = function () {
    // add this class to resize the parent div to max
    // allowed size. 90px in adsense.
    this.addClass(this.adContainerDiv,'aspect-mode');
