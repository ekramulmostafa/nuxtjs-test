...
// file that is output assumes that Video.js is available at `window.videojs`.
        ...
        ChromecastTech = {
            ...
            constructor: function(options) {
                ...
                // to return custom data - used for live streaming
                this._requestCustomData = options.requestCustomDataFn || _.noop;
                this._requestPosterData = options.requestPosterfn || _.noop;
            ...
            _playSource: function(source, startTime) {
                var castSession = this._getCastSession(),
                    ...
                    customData = this._requestCustomData(),
                    images = this._requestPosterData(),
                    deviceFriendlyName = castSession.getCastDevice().friendlyName,
                    request;
                ...
                mediaInfo.deviceFriendlyName = deviceFriendlyName;

                this._ui.updateTitle(title);
                this._ui.updateSubtitle(subtitle);
                this._ui.updateDeviceName(deviceFriendlyName);
        ...
        ChromecastTechUI = Class.extend(/** @lends ChromecastTechUI.prototype */ {
            ...
            _createDOMElement: function() {
                ...
                var el = this._createElement('div', 'vjs-tech vjs-tech-chromecast'),
                    ...
                    deviceContainer = this._createElement('div', 'vjs-tech-chromecast-device-container'),
                    deviceNameEl = this._createElement('span', 'vjs-tech-chromecast-device-name');


                posterContainerEl.appendChild(posterImageEl);
                titleContainer.appendChild(titleEl);
                titleContainer.appendChild(subtitleEl);
                deviceContainer.appendChild(deviceNameEl);
                titleContainer.appendChild(deviceContainer);
            ...
            _findDeviceEl: function() {
                return this._el.querySelector('.vjs-tech-chromecast-device-name');
            },
            ...
            updateDeviceName : function(deviceName){
                var deviceEL = this._findDeviceEl();
                this._deviceName = deviceName;

                if(deviceName){
                    deviceEL.innerHTML = 'Playing On ' + '<strong>'+ deviceName+'</strong>';
                } else {
                    console.log("device friendly name was not found");
                }
            },
