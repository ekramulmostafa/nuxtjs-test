/*! @silvermine/videojs-chromecast 2018-04-17 v1.0.1 */
    ...
    10: [ function(require, module, exports) {
        ...
        ChromecastTech = {
            ...
            _playSource: function(source, startTime) {
                var castSession = this._getCastSession(), mediaInfo = new chrome.cast.media.MediaInfo(source.src, source.type), title = this._requestTitle(source), subtitle = this._requestSubtitle(source), request;
